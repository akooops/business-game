<script>
    ...
    const breadcrumbs = [
        ...
        {
            title: 'Edit',
            url: route('admin.banks.edit', { bank: bank.id }),
            active: true
        }
    ];
    ...
    let formData = {
        name: bank.name || '',
        loan_duration_months: bank.loan_duration_months || '',
        loan_interest_rate: bank.loan_interest_rate || '',
        loan_max_amount: bank.loan_max_amount || '',
        file: null
    };
    ...
    async function handleSubmit() {
        ...
        try {
            ...
            router.post(route('admin.banks.update', { bank: bank.id }), formData, {
                onError: (err) => {
                    errors = err;
                    loading = false;
                },
        ...
        <div class="grid gap-5 lg:gap-7.5">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex flex-col gap-1">
                    <h1 class="text-2xl font-bold text-mono">Edit Bank</h1>
                    <p class="text-sm text-secondary-foreground">
                        Update bank information and lending terms
                    </p>
                </div>
