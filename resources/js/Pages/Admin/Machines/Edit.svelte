<script>
    ...
    let formData = {
        ...
        min_predictive_maintenance_delay_hours: machine.min_predictive_maintenance_delay_hours || '',
        avg_predictive_maintenance_delay_hours: machine.avg_predictive_maintenance_delay_hours || '',
        max_predictive_maintenance_delay_hours: machine.max_predictive_maintenance_delay_hours || '',
        ...
        min_corrective_maintenance_delay_hours: machine.min_corrective_maintenance_delay_hours || '',
        avg_corrective_maintenance_delay_hours: machine.avg_corrective_maintenance_delay_hours || '',
        max_corrective_maintenance_delay_hours: machine.max_corrective_maintenance_delay_hours || '',
        file: null,
