<script>
    ...
    let form = {
        ...
        monthly_min_salary: employeeProfile.monthly_min_salary || '',
        monthly_avg_salary: employeeProfile.monthly_avg_salary || '',
        monthly_max_salary: employeeProfile.monthly_max_salary || '',
