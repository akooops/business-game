<script>
    ...
    async function fetchAdvertisers() {
        ...
        try {
            ...
            const response = await fetch(route('admin.advertisers.index') + '?' + params.toString(), {
                headers: {
    ...
    async function deleteAdvertiser(advertiserId) {
        ...
        try {
            ...
            const response = await fetch(route('admin.advertisers.destroy', { advertiser: advertiserId }), {
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                },
            ...
            if (response.ok) {
                ...
                // Refresh the advertisers list
                fetchAdvertisers();
            } else {
                const errorData = await response.json().catch(() => ({}));
                const errorMessage = errorData.message || 'Error deleting advertiser. Please try again.';
        ...
        <div class="grid gap-5 lg:gap-7.5">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex flex-col gap-1">
                    <h1 class="text-2xl font-bold text-mono">Advertisers Management</h1>
                    <p class="text-sm text-secondary-foreground">
                        Manage advertisers and their advertising services for the business game
                    </p>
                </div>
                <div class="flex items-center gap-3">
                    <a href="{route('admin.advertisers.create')}" class="kt-btn kt-btn-primary">
                        ...
                        <table class="kt-table kt-table-border table-fixed">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <span class="kt-table-col">
                                            <span class="kt-table-col-label">Advertiser</span>
                                        </span>
                                    </th>
                                    <th>
                                        <span class="kt-table-col">
                                            <span class="kt-table-col-label">Price Range</span>
                                        </span>
                                    </th>
                                    <th>
                                        <span class="kt-table-col">
                                            <span class="kt-table-col-label">Market Impact</span>
                                        </span>
                                    </th>
                                    <th>
                                        <span class="kt-table-col">
                                    ...
                                    <tr>
                                        <td colspan="6" class="p-10">
                                            <div class="flex flex-col items-center justify-center text-center">
                                                <div class="mb-4">
                                                    <i class="ki-filled ki-advertiser text-4xl text-muted-foreground"></i>
                                                </div>
                                                <h3 class="text-lg font-semibold text-mono mb-2">No advertisers found</h3>
                                                <p class="text-sm text-secondary-foreground mb-4">
                                                    {search ? 'No advertisers match your search criteria.' : 'Get started by adding your first advertiser.'}
                                                </p>
                                                <a href="{route('admin.advertisers.create')}" class="kt-btn kt-btn-primary">
                                                    <i class="ki-filled ki-plus text-base"></i>
                                ...
                                {:else}
                                    ...
                                    {#each advertisers as advertiser}
                                        <tr class="hover:bg-muted/50">
                                            <td>
                                                <span class="text-sm font-medium text-mono">#{advertiser.id}</span>
                                            </td>
                                            <td>
                                                <div class="flex items-center gap-3">
                                                    <div class="flex-shrink-0">
                                                        ...
                                                        {:else}
                                                            <div class="w-10 h-10 rounded-lg bg-accent/50 flex items-center justify-center">
                                                                <i class="ki-filled ki-advertiser text-lg text-muted-foreground"></i>
                                                            </div>
                                                        {/if}
                                                    </div>
                                                    <div class="flex flex-col gap-1">
                                            ...
                                            <td class="text-center">
                                                <div class="kt-menu flex-inline" data-kt-menu="true">
                                                    <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
                                                        <button class="kt-menu-toggle kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost" aria-label="Advertiser actions menu">
                                                            <i class="ki-filled ki-dots-vertical text-lg"></i>
                                                        </button>
                                                        <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link" href={route('admin.advertisers.show', { advertiser: advertiser.id })}>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link" href={route('admin.advertisers.edit', { advertiser: advertiser.id })}>
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <button class="kt-menu-link" on:click={() => deleteAdvertiser(advertiser.id)}>
                                                                    <span class="kt-menu-icon">
