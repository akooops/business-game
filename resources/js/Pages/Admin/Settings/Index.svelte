<script>
    ...
    function handleValueChange(setting, newValue) {
        ...
        if (setting.type === 'array') {
            ...
            setting.value = parseFloat(newValue) || 0;
        } else {
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="min-w-[200px]">
                                        <span class="kt-table-col">
                                            <span class="kt-table-col-label">Setting</span>
                                        </span>
                                    </th>
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    {:else if setting.type === 'number'}
                                                        <input
                                                            ...
                                                            max={setting.options?.max || undefined}
                                                    ...
                                                    {:else if setting.type === 'select'}
                                                        <select
                                                            ...
                                                            on:change={(e) => handleValueChange(setting, e.target.value)}
                                                        >
