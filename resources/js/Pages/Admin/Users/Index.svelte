<script>
    ...
    async function deleteUser(userId) {
        ...
        try {
            ...
            const response = await fetch(route('admin.users.destroy', { user: userId }), {
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                },
        ...
        <div class="grid gap-5 lg:gap-7.5">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex flex-col gap-1">
                    <h1 class="text-2xl font-bold text-mono">Users Management</h1>
                    <p class="text-sm text-secondary-foreground">
                        Manage your simulation users
                    </p>
                </div>
                                    ...
                                    <tr>
                                        <td colspan="8" class="p-10">
                                            <div class="flex flex-col items-center justify-center text-center">
                                                ...
                                                <h3 class="text-lg font-semibold text-mono mb-2">No users found</h3>
