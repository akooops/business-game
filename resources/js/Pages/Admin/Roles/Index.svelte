<script>
    ...
    async function deleteRole(roleId) {
        ...
        try {
            ...
            const response = await fetch(route('admin.roles.destroy', { role: roleId }), {
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                },
            ...
            if (response.ok) {
                ...
                const errorMessage = errorData.message || 'Error deleting role. Please try again.';
        ...
        <div class="grid gap-5 lg:gap-7.5">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex flex-col gap-1">
                    <h1 class="text-2xl font-bold text-mono">Roles Management</h1>
                    <p class="text-sm text-secondary-foreground">
                        Manage your simulation roles and content
                    </p>
                </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="min-w-[150px]">
                                        <span class="kt-table-col">
                                            <span class="kt-table-col-label">Default</span>
                                        </span>
                                    </th>
                                    <th class="w-[80px]">
                                        <span class="kt-table-col">
                                ...
                                {:else}
                                    ...
                                    {#each roles as role}
                                        <tr class="hover:bg-muted/50">
                                            <td>
                                                <input class="kt-checkbox kt-checkbox-sm" type="checkbox" value={role.id}/>
                                            </td>
                                            <td>
                                                <span class="text-sm font-medium text-mono">#{role.id}</span>
                                            </td>
                                            <td>
                                                ...
                                                <div class="kt-menu flex-inline" data-kt-menu="true">
                                                    <div class="kt-menu-item" data-kt-menu-item-offset="0, 10px" data-kt-menu-item-placement="bottom-end" data-kt-menu-item-placement-rtl="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click">
                                                        ...
                                                        <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                                            {#if hasPermission('admin.roles.show')}
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link" href={route('admin.roles.show', { role: role.id })}>
                                                            ...
                                                            <div class="kt-menu-item">
                                                                <a class="kt-menu-link" href={route('admin.roles.edit', { role: role.id })}>
                                                                    <span class="kt-menu-icon">
                                                            ...
                                                            {/if}
                                                            {#if !role.is_default && hasPermission('admin.roles.destroy')}
                                                                <div class="kt-menu-separator"></div>
                                                                <div class="kt-menu-item">
                                                                    <button class="kt-menu-link" on:click={() => deleteRole(role.id)}>
                                                                        <span class="kt-menu-icon">
