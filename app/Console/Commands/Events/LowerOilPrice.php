...
class LowerOilPrice extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'game:lower-oil-price';
     ...
     * @var string
     */
    protected $description = 'Lower oil price';
    ...
    {
        $this->info('Queueing oil price lowering job...');
        ...
        foreach($suppliers as $supplier){
            if($supplier){
                ...
                $this->info('Supplier ' . $supplier->name . ' lowered successfully');
            }
        }
        ...
        NotificationService::createOilPriceLoweredNotification($rate);
    }
} 