...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('machines', function (Blueprint $table) {
            ...
            $table->decimal('area_required', 15, 3)->default(0);
            $table->integer('setup_time_days')->default(1);

            // Performance
            $table->decimal('energy_consumption_hour', 15 ,3)->default(0);
            $table->decimal('carbon_emissions_hour', 15, 3)->default(0);
            $table->decimal('quality_factor', 15, 3)->default(0);

            // Speed
            $table->decimal('min_speed_hour', 15, 3)->default(0);
            $table->decimal('avg_speed_hour', 15, 3)->default(0);
            $table->decimal('max_speed_hour', 15, 3)->default(0);
